...
| 002 | chroma-1-5-9-toolchain-floor | standard | Given the final spike lockfile, when toolchain requirements are validated, then the Rust MSRV, CI pin, and protoc requirement can be stated accurately | VALIDATED | rust, msrv, protoc, phase-11 |
